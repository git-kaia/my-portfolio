// components/icons/EmailIcon.jsx
    ...
    >
      <g id="Uploaded_to_svgrepo.com" data-name="Uploaded to svgrepo.com">
        <g>
          <path
            className="stripes"
            d="M2.954,7.953L2.247,7.246L3.493,6h1.414L2.954,7.953z M8.907,6H7.493L4.247,9.246l0.707,0.707L8.907,6z
		...
		l0.707,0.707L16.907,6z"
          ...
          <path
            className="line"
            d="M31.992,5.969c-0.004-0.119-0.021-0.238-0.068-0.352C31.769,5.244,31.404,5,31,5H1
